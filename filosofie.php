...
<div class="content">
  ...
  <li><a href="index.php">Acasa</a></li>
	...
	<button class="btn" onclick="window.location.href='ECCGWDD.php'">Esti ceea ce gandesti - Wayne D Dyer</button>
    <br><br>
	<button class="btn" onclick="window.location.href='SMGB.php'">Scrieri Metafizice - George Berkeley</button>
    <br><br>
	<button class="btn" onclick="window.location.href='busido.php'">Busido - Inazo Nitobe</button>
    <br><br><br><br>
